...
/**
 * Clase para la creación de un max heap con sus operaciones de inserción y eliminación.
 * @author  Luis Angel Quintana Mora
 * @version 04 Dic 2022
 */

public class MaxHeap extends ArbolBin {
    private int tamano;
    public MaxHeap() {
        super();
    ...
    /**
     * Método para inserción de un nodo en un max heap.
    ...
    /**
     * Método para eliminar un nodo a partir de un valor de un max heap
    ...
    /**
     * Método para eliminación de una hoja del árbol.
    ...
    public Nodo swap(Nodo hijo, Nodo padre){
        ...
        // los datos del padre ahora estarán en el hijo
        hijo.valor = temp;
    ...
    /**
     * Método para colocar el nuevo nodo en la última posición disponible.
     * @param nuevo el nodo que se posicionará en la última posición disponible.
     */
